...
public class MastermindSolver_Ver3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MastermindSolver_Ver3 frame = new MastermindSolver_Ver3();
					frame.setVisible(true);
					frame.setTitle("Mastermind Solver Ver3.1.3");
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public MastermindSolver_Ver3() {
		...
		lblPleaseEnterYour.setFont(new Font("Lithos Pro", Font.PLAIN, 11));
		...
		averageCheckbox.setBounds(10, 234, 163, 18);
		...
		btnClickHereTo.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(averageCheckbox.getState() && algorithmRB.isSelected() ){
				...
				if( algorithmRB.isSelected() && !averageCheckbox.getState() ){ // determine which algorithm would apply.
				...
				if(averageCheckbox.getState() && algorithmRB_1.isSelected() ){
				...
				if( algorithmRB_1.isSelected() && !averageCheckbox.getState() ){ // determine which algorithm would apply.
				...
				// Then the function calculate the second algorithm's average guess times.
				if(averageCheckbox.getState() && algorithmRB_2.isSelected() ){
				...
				// Then the function guess the input number by using algorithm 2.
				if( algorithmRB_2.isSelected() && !averageCheckbox.getState() ){ // determine which algorithm would apply.
		...
		btnClickHereTo.setFont(new Font("Lithos Pro", Font.PLAIN, 12));
		btnClickHereTo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			}
		});
		btnClickHereTo.setBounds(5, 264, 280, 29);
		...
		btnClear.setFont(new Font("Lithos Pro", Font.PLAIN, 12));
		btnClear.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		btnClear.setBounds(309, 264, 117, 29);
